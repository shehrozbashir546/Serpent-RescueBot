        ...
        if (world[rup] == '#' || forbidden(rup)) { 
            ...
            if (countleft < countright || countleft == countright) {
                if (((world[rleft]) == '#' || forbidden(rleft))){
                    ...
                    if (right_destructable(world[rright]) == true) goto checkpoint;
                    return right;  
                }  
                ...
                do{                 
                    ...
                    if (left_destructable(world[rleft]) == true) goto checkpoint;
                    return left;
                }
                ...
                for (int i=0; i<moveleft;i++){
                    ...
                    if (up_destructable(world[rup]) == true) goto checkpoint;
                    return up;
                }
            }
